...
print.mfa <- function(mfa, ...) {
  cat(mfa$common_factor_scores) # Prints the compromise
  cat(mfa$partial_factor_scores) # Prints the partial factor scores
  cat(mfa$factor_loadings) # Prints the variable loadings
  invisible(mfa)
}
...
print.mfa.fpart <- function(mfa,...) {
  print(mfa$partial_factor_scores)
}
